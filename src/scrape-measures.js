/**
 *
 * Scrape and store measures data
 *
 * USAGE: NODE_ENV=<ENV> node dist/scrape-measures.js [YEAR]
 *
...
const usage = () => {
  console.log();
  console.log('USAGE: NODE_ENV=<ENV> node dist/scrape-measures.js [YEAR]');
  console.log();
...
import MeasureScraper from './measure-scraper.js';

MeasureScraper.run(year);
